...
<div class="container">
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form action="/xiangmu/admin.php/Login/loginok" method="POST">
                ...
                <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                    ...
                    <div class="form-group">
                        <div class="field">
                           ...
                           <img src="/xiangmu/admin.php/Login/code" alt="" width="100" height="32" class="passcode" style="height:43px;cursor:pointer;" onclick="this.src='/xiangmu/admin.php/Login/code/'+Math.random()">  

                            <!-- <img onclick="this.src='/xiangmu/admin.php/Login/code/'+Math.random()"style="cursor:pointer" src="/xiangmu/admin.php/Login/code"/>         -->             
                        </div>
                    </div>
                </div>
                <div style="padding:30px;"><input type="submit" class="button button-block bg-main text-big input-big" value="登录"><br>
                <a href="/xiangmu/admin.php/Login/add" class="button button-block bg-main text-big input-big">点击注册</a>
                </div>
            </div>
            </form>          
        </div>
